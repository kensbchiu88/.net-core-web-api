...
namespace PolarBearEapApi.ApplicationCore.Services
{
    public class GetInvalidtimeBySnCommand : IMesCommand
    {
        ...
        public GetInvalidtimeBySnCommand(IMesService equipmentService, ITokenRepository tokenRepository)
        {
        ...
        public async Task<MesCommandResponse> Execute(MesCommandRequest input)
        {
            ...
            try
            {
                string mesReturn = await _equipmentService.GET_INVALIDTIME_BY_SN(sn!, token.username!);
